...
local Window = Library:CreateWindow({Title = 'Deadline.gg ESP',Center = true,AutoShow = true,TabPadding = 8,MenuFadeTime = 0.2})
local Tabs = {Visual = Window:AddTab('ESP'),['UI Settings'] = Window:AddTab('UI Settings'),}
...
MenuGroup:AddButton('off', function() Library:Unload() end)
