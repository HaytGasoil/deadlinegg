...
local Window = Library:CreateWindow({Title = 'Deadline.gg | https://discord.gg/Bsnh2p2htF',Center = true,AutoShow = true,TabPadding = 8,MenuFadeTime = 0.2})
local Tabs = {Main = Window:AddTab('Main'),Visual = Window:AddTab('ESP'),['UI Settings'] = Window:AddTab('UI Settings'),}

--Tables
local Functions = {}
local Esp = {Settings={
    Boxes=true,BoxesOutline=true,BoxesColor=Color3.fromRGB(82,255,250),BoxesOutlineColor=Color3.fromRGB(0,0,0),
    Sleeping=false,SleepingColor=Color3.fromRGB(82,255,250),
    Distances=false,DistanceColor=Color3.fromRGB(82,255,250),
    Armour=false,ArmourColor=Color3.fromRGB(82,255,250),
    Tool=false,ToolColor=Color3.fromRGB(82,255,250),
...
local WatermarkConnection = game:GetService('RunService').RenderStepped:Connect(function()
    ...
    Library:SetWatermark(('Deadline.gg| %s fps | %s ms'):format(
        math.floor(FPS),
...
MenuGroup:AddButton('https://discord.gg/Bsnh2p2htF', function() Library:Unload() end)
...
ThemeManager:SetFolder('Deadline')
SaveManager:SetFolder('Deadline/TridentSurvivalNoActor')
SaveManager:BuildConfigSection(Tabs['UI Settings'])
ThemeManager:ApplyToTab(Tabs['UI Settings'])
SaveManager:LoadAutoloadConfig()

Library:Notify("Deadline.gg activated✅",8)
Library:Notify("https://discord.gg/Bsnh2p2htF",15)